...
This project contains code and ideas derived from the original **sts2-undo-mod** project by **inggom**.
...
This project is an independent community modification and is not affiliated with or endorsed by the original author.
